...
def image():
    if request.method == 'POST':
        ...
        elif predicted_class == 'cancer_stage1':
            str_label = "cancer_stage1"
            

        elif predicted_class == 'cancer_stage2':
            str_label = "cancer_stage2"
            

        elif predicted_class == 'cancer_final_stage':
            str_label = "cancer_final_stage"
